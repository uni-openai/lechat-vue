...
export default {
    ...
    chat: {
        ...
        turnOnContext: 'Online Mode: messages will be feed to search engine and not carry previous chat records.',
        turnOffContext: 'Offline Mode, messages will not be feed to search engine and carry previous chat records.',
